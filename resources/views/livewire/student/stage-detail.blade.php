<div class="mx-auto flex max-w-5xl flex-col gap-6">
    @php
        ...
        $agreementStatus = $application->agreement?->status; // te_ondertekenen | ingediend | bevestigd | null
    ...
    {{-- Terug naar de lijst --}}
    <a href="{{ route('student.stage') }}" wire:navigate class="inline-flex items-center gap-1.5 text-sm font-medium text-neutral-500 hover:text-[#E2231A] dark:text-neutral-400">
        <flux:icon name="arrow-left" class="size-4" /> Mijn stages
    </a>
    ...
    @if ($appStatus !== 'rejected')
        <div class="grid gap-6 lg:grid-cols-3">
            ...
            <div class="flex flex-col gap-6">
                <div class="rounded-xl border border-neutral-200 bg-white p-6 dark:border-neutral-800 dark:bg-neutral-900">
                    ...
                    @php
                        $checklist = [
                            ...
                            ['Overeenkomst getekend', in_array($agreementStatus, ['ingediend', 'bevestigd'], true)],
                ...
                @elseif ($appStatus === 'approved' && (! $agreementStatus || $agreementStatus === 'te_ondertekenen'))
                    <div class="rounded-xl border border-neutral-200 bg-white p-5 dark:border-neutral-800 dark:bg-neutral-900">
                        <p class="text-sm text-neutral-600 dark:text-neutral-300">Je aanvraag is goedgekeurd. Onderteken je stageovereenkomst zodra je mentor akkoord geeft.</p>
                        <flux:button href="{{ route('student.agreement') }}" wire:navigate variant="primary" icon="pencil-square" class="mt-3 w-full">
                ...
                @elseif ($agreementStatus === 'ingediend')
                    <div class="rounded-xl border border-amber-200 bg-amber-50 p-5 text-sm text-amber-800 dark:border-amber-900/50 dark:bg-amber-950/40 dark:text-amber-200">
                        Je overeenkomst is getekend en wacht op bevestiging door de stagecommissie.
                    </div>
