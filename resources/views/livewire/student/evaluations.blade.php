        ...
        <div class="rounded-xl border border-neutral-200 bg-white p-6 dark:border-neutral-800 dark:bg-neutral-900">
            <div class="flex flex-wrap items-center justify-between gap-4">
                <div>
                    ...
                    <p class="mt-2 flex items-center gap-1.5 text-sm text-neutral-500 dark:text-neutral-400">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <flux:icon name="arrow-down-tray" class="size-5 text-neutral-400 dark:text-neutral-500" />
                    <span class="rounded-full bg-neutral-100 px-3 py-1 text-sm font-medium text-neutral-600 dark:bg-neutral-800 dark:text-neutral-300">Bekeken</span>
                </div>
            </div>
        </div>
    @else
